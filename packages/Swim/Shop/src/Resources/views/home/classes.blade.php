@if (app('Swim\Classes\Repositories\ClassesRepository')->getFeaturedClasses()->count())
    <section class="featured-products">
        ...
        <div class="featured-grid product-grid-4">
          ...
          <div class="featured-grid product-grid-4"><div class="product-card"><div class="product-image"><a href="http://127.0.0.1:8000/sunglasses" title="Sunglasses"><img src="http://127.0.0.1:8000/vendor/Swim/ui/assets/images/product/meduim-product-placeholder.png" onerror="this.src='http://127.0.0.1:8000/vendor/Swim/ui/assets/images/product/meduim-product-placeholder.png'"></a></div> <div class="product-information"><div class="product-name"><a href="http://127.0.0.1:8000/sunglasses" title="Sunglasses"><span>
                    Sunglasses
