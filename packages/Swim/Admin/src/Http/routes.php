    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::prefix('master')->group(function () {
                     Route::get('/branch', 'Swim\Admin\Http\Controllers\Master\BranchController@index')->defaults('_config', [
                    'view' => 'admin::master.branch.index'
                ])->name('admin.master.branch.index');
            });    
